...
# Monkey patching
import bcc.table
bcc.table._print_log2_hist = \
    lambda vals, val_type, strip_leading_zero: print_hist(vals, val_type)
...
def print_hist(vals, val_type):
  ...
  with open('biolatency.svg', 'w+') as fout:
    barchart.render(fout, 'Disk I/O Latency', val_type, val_max, rows)
